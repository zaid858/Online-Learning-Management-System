...
export default function Navbar() {
  ...
  // Translation mappings for Navbar items
  const translations = {
    en: {
      'Home': 'Home',
      'Courses': 'Courses',
  ...
  // Check login, role, and language states whenever user navigates or makes updates
  useEffect(() => {
    const checkState = () => {
        ...
        <div className="navbar-actions">
          ...
          {isLoggedIn ? (
            <div className="user-profile-menu">
              <Link to="/profile" className="profile-link-wrap" title="Go to Dashboard">
