...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      description: 'Watch courses and videos with note-taking mechanisms directly integrated.',
      badge: 'Immersive'
    },
    {
      iconName: 'BarChart2',
      title: 'Progress & Analytics',
      description: 'Track quiz scores, completion badges, and syllabus progress automatically.',
      badge: 'Analytics'
    }
  ];
      ...
      <header className="hero-section text-center">
        <div className="container hero-container-centered animate-fade-in">
          ...
          <p className="hero-subtitle">
            Access professionally curated courses, interactive quizzes, and track your progress in real-time.
          </p>
