    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">{t('Sign in Subtitle')}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="email">{t('Email or Username')}</label>
            <div className="input-with-icon">
              ...
              <input
                ...
                placeholder={t('Enter email/user placeholder')}
              />
            </div>
            {errors.email && (
          ...
          <div className="form-group">
            <div className="form-label-row">
              ...
              <a href="#forgot" className="forgot-password" onClick={(e) => { e.preventDefault(); alert(t('Password reset system linked to mock email provider.')); }}>{t('Forgot?')}</a>
            </div>
            <div className="input-with-icon">
          ...
          {/* Role selector field */}
          <div className="form-group">
            <label className="form-label" htmlFor="role">{t('Sign In As')}</label>
            <select
              id="role"
              name="role"
              value={formData.role}
          ...
          <button type="submit" className="btn btn-primary btn-full submit-btn" disabled={isSuccess}>
            {isSuccess ? t('Logging In') : t('Log In')}
          </button>
        </form>
